...
<div class="wrapper">
    ...
    <div class="container">
		...
		<form action='/carful/index.php/Home/Admin/AdminDoLogin' method='post' name='myForm'>
			用户名：<input type='text' name='username'/><br/>
			密　码：<input type='password' name='password'/><br/>
			验证码：<input type='text' name='code'/>
					<img src='/carful/index.php/Home/Admin/code' onclick="javascript:this.src=this.src+'?'+Math.random()"/>
					<br/>
